...
FROM 'C:\Users\ghost\Desktop\postgresSQL\practical-sql-main\Chapter_10\acs_2011_2015_stats.csv'
...
FROM 'C:\Users\ghost\Desktop\postgresSQL\practical-sql-main\Chapter_10\fbi_crime_data_2015.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
...
property_crime,
round(
 (property_crime / population) * 1000, 1
) AS pc_per_1000
FROM fbi_crime_data_2015
WHERE population >= 500000
ORDER BY (property_crime / population) DESC;
...
round(corr(median_hh_income, pct_masters_higher)::numeric, 2) AS masters_income_r
FROM acs_2011_2015_stats;

--Try it yourself 2

SELECT
city,st,population,motor_vehicle_theft,
round((motor_vehicle_theft::numeric / population) * 100000, 1) AS vehicle_theft_per_100000
FROM fbi_crime_data_2015
WHERE population >= 500000
