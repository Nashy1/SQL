...
FROM 'C:\Users\ghost\Desktop\postgresSQL\practical-sql-main\Chapter_08\pls_fy2014_pupld14a.csv'
...
FROM 'C:\Users\ghost\Desktop\postgresSQL\practical-sql-main\Chapter_08\pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER);
...
SELECT city, stabr
FROM pls_fy2014_pupld14a
WHERE city NOT IN ('YORK','ABBEVILLE')
GROUP BY city, stabr
ORDER BY city DESC, stabr;
